$(function () {
    var W, H,
        canvas, ctx, //ctx = "curso" 
        particleCount = 400,
        particles = []; // array will hold particles Object/Class
    W = /*window.innerWidth*/ 1500 ;
    H = /*window.innerHeight*/ 650 ;
    
    canvas = $(".cvfx").get(0); //this "get(0) will pull the underlying non-jquery wrapped dom element from our selection
    canvas.width = W;
    canvas.height = H;
    ...
    function Particle() {
        ...
        this.h=parseInt(50);
        this.s=parseInt(100 * Math.random() + 30);
        this.l=parseInt(56 * Math.random() + 30);
